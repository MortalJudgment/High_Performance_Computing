function [x,res,it,time]=Backward_GaussSeidel(A,b,x0,tol,itmax)
% BACKWARD GAUSSSEIDEL Resolution of linear systems
%   [x,res]=BACKWARD_GAUSSSEIDEL(A,b,x0,tol,itmax) solves Ax = b by
