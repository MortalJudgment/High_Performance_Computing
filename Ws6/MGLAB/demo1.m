...
demo1_uic_continue = uicontrol(	...
		'units', 'normalized',...
        'Position', [0.1 0.05 0.20 0.07],...
		'style', 'pushbutton', ...
		'string', 'Continue',...
